...
from ..migrated import format_number_with_separator
...
def stats_page():
    ...
    if Config.is_python_backend():
        # Python backend: Could use migrated format_number_with_separator
        # For now, still proxy to OCaml (statistics require database access)
        pass
