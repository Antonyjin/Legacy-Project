...
- Surfaces covered here:
  ...
  - HTML ancestor list page (Charles Windsor's ancestors with hierarchical structure)
...
- goldens/v1/expected_ancestors_charles.html.norm # ancestor list (Charles Windsor's ancestors)
